...
export const questionCards_1: QuestionCard[] = [
  {
    questionText: "JavaScript используется для",
    answerOptions: [
      {
        id: "1.1.1",
        name: "q1.1",
        value: "1",
        text: "создания и управления динамическим содержимым веб-страниц и придания сайту интерактивности",
      },
      {
        id: "1.1.2",
        name: "q1.1",
        value: "0",
        text: "декорирования и описания внешнего вида документа (веб-страницы)",
      },
      {
        id: "1.1.3",
        name: "q1.1",
        value: "0",
        text: "определения структуры и содержимого страницы",
      }
    ],
    ...
    answerOptions: [
      {
        ...
        name: "q1.6",
        value: "0",
        text: "это обозначения документа HTML",
      },
      {
        id: "1.6.2",
        name: "q1.6",
        value: "0",
        text: "это предсталение тегов в виде дерева",
      },
      {
        id: "1.6.3",
        name: "q1.6",
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        name: "q1.7",
        value: "0",
        text: "это то, каким образом в браузере представлен документ",
      },
    ],
    ...
    answerOptions: [
      {
        ...
        name: "q1.8",
        value: "0",
        text: "потому что это единственное место, где следует подключать script",
      },
      {
        id: "1.8.2",
        name: "q1.8",
        value: "1",
        text: "чтобы пользователь увидел контент как можно раньше",
      },
      {
        id: "1.8.3",
        name: "q1.8",
        value: "0",
        text: "чтоб не возникло ситуации, когда контент уже есть, но интерактивности еще нет",
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        name: "q1.9",
        value: "0",
        text: "просто подключать скрипт в начале документа, это ни на что не повлияет",
      }
    ],
    ...
    answerOptions: [
      {
        ...
        name: "q1.11",
        value: "0",
        text: "let для примитивных типов данных, const для объектов",
      },
      {
        id: "1.11.2",
        name: "q1.11",
        value: "0",
        text: "переменные, объявленные с помощью const, поднимаются, а с помощью let - нет",
      },
      {
        id: "1.11.3",
        name: "q1.11",
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        name: "q1.16",
        value: "0",
        text: "используя директиву 'use strict', мы учлучшаем позицию сайта при поисковой выдаче",
      ...
      },
      {
        ...
        name: "q1.16",
        value: "0",
        text: "'use strict' визуально отобразит наличие ошибок прямо в коде",
